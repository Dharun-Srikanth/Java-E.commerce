...
public class StringUtil {
    ...
    public static final String ENTRY_OPTION = "Do you want to Explore site? y/n: ";
    ...
    public static final String PASSWORD_MISMATCH = "Mismatch Password!!";
